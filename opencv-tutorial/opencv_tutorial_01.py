...
h, w, c = image.shape
print(f'width = {w} height = {h} depth = {c}')
...
# output = image.copy()  # drawing operations on images are performed in-place. we make a copy of the original image storing the copy as output
